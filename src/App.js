  ...
  return (
    <div className="App">
      ...
      <div className="info-section">
        <div className="inner-section container">
          <div class="row justify-content-center text-center align-items-center">
            <div
              class="col-xl-8 col-lg-9 col-md-10 layer-3 aos-init aos-animate"
              data-aos="fade-up"
              data-aos-delay="500"
            >
              <h1 class="display-3">Advanced Statistics</h1>
              <div class="mb-4">
      ...
      >
        <div class="row justify-content-center text-center align-items-center">
          <div
            class="col-xl-8 col-lg-9 col-md-10 text-container"
            data-aos="fade-up"
            data-aos-delay="500"
          >
            <h1 class="display-3">Boost your links today</h1>
            <div class="mb-4">
